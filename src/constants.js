...
function obtenerYTime(timestampEnSegundos) {
  ...
  return "ytime=".concat(hora, ":").concat(minutos, ";");
}
let location = 'es';
...
module.exports = Object.freeze({
  ...
  GENERATOR_URL: "https://yopmail.com/".concat(location, "/email-generator"),
  READ_MAIL_URL: (mail, id) => "https://yopmail.com/".concat(location, "/mail?b=").concat(mail, "&id=m").concat(id),
  WRITE_MAIL_URL: mail => "https://yopmail.com/".concat(location, "/write?b=").concat(mail, "&id="),
  DELETE_INBOX_URL: (mail, id, yp, yj, ver) => "https://yopmail.com/".concat(location, "/inbox?login=").concat(mail, "&p=1&d=all&ctrl=").concat(id, "&yp=").concat(yp, "&yj=").concat(yj, "&v=").concat(ver, "&r_c=&id=&ad=0"),
  DELETE_MESSAGE_URL: (mail, id, yp, yj, ver) => "https://yopmail.com/".concat(location, "/inbox?login=").concat(mail, "&p=1&d=").concat(id, "&ctrl=&yp=").concat(yp, "&yj=").concat(yj, "&v=").concat(ver, "&r_c=&id=&ad=0"),
  SEND_MESSAGE_URL: "https://yopmail.com/".concat(location, "/writepost"),
  INPUT_YP: 'input#yp',
  REGEX_LOCATION: /lang="(.*?)"/,
  REGEX_YJ: /&yj=([^&]+)&v=/,
  REGEX_TOTAL_MAILS: /w\.finrmail\((.*?)\)/,
  INBOX_URL: function (mail, yp, yj, ver) {
    let page = arguments.length > 4 && arguments[4] !== undefined ? arguments[4] : 1;
    return "https://yopmail.com/".concat(location, "/inbox?login=").concat(mail, "&p=").concat(page, "&d=&ctrl=&yp=").concat(yp, "&yj=").concat(yj, "&v=").concat(ver, "&r_c=&id=&ad=0");
  },
  INBOX_HTTP_CONFIG: (cookie, mail) => ({
    headers: {
      'accept': 'text/html,application/xhtml+xml,application/xml;q=0.9,image/avif,image/webp,image/apng,*/*;q=0.8,application/signed-exchange;v=b3;q=0.7',
      'cookie': "".concat(cookie, "; compte=").concat(mail, "; ywm=").concat(mail, "; __gads=ID=9a0b3cce9ff31bac:T=").concat(timeStampInSeconds(), ":RT=").concat(timeStampInSeconds(), ":S=ALNI_MZ3k3gFQXDYCyC-n7CnlRltSEFoVQ; __gpi=UID=00000a0a4f90dd17:T=").concat(timeStampInSeconds(), ":RT=").concat(timeStampInSeconds(), ":S=ALNI_MbohrBpXt1O26O3LDmi-KRsCVPhcw; __eoi=\"ID=5cd00b43a530b6a4:T=").concat(timeStampInSeconds(), ":RT=").concat(timeStampInSeconds(), ":S=AA-Afjb4QKVvFIwSmOYMSnui2gGd\"; FCNEC=%5B%5B%22AKsRol_M2LZFqBb7LSYXadLKqvJ5hTBhxAex9zsoE4N4YD_W5EKTjaIdnSjUL1onQWaOaUq-2HI8vZCE9bqnfMfFE9XOzzqfKK3c3UA5WvJQYW6YtylSfhXH3FZ4WTR9pzl8dTHsGaiJSwztPBvgXHwUPGcOlsELSQ%3D%3D%22%5D%5D;compte=").concat(mail, "; ywm=").concat(mail, "; ").concat(obtenerYTime(timeStampInSeconds())),
      'accept-encoding': 'gzip, deflate, br',
      'accept-language': 'es-ES,es;q=0.9',
      'connection': 'keep-alive',
      'host': 'yopmail.com',
      'referer': "https://yopmail.com/".concat(location, "/wm"),
  ...
  RSS_HTTP_CONFIG: (cookie, mail) => ({
    'accept': 'text/html,application/xhtml+xml,application/xml;q=0.9,image/avif,image/webp,image/apng,*/*;q=0.8,application/signed-exchange;v=b3;q=0.7',
    'cookie': "".concat(cookie, "; _ga=GA1.2.503151223.1683393694; _gid=GA1.2.1659462416.1683393694; __gads=ID=1aef015d5c605919-2289ab29f27f0062:T=1683393694:RT=1683393694:S=ALNI_MYhXB3g-Ape8Bl2op45lGwvANkLFg; __gpi=UID=000009f291461986:T=1683393694:RT=").concat(timeStampInSeconds(), ":S=ALNI_MZM6T_Gt5i9mVk7fSPYTS_lNnT05A; compte=").concat(mail, "; ywm=").concat(mail, "; ").concat(obtenerYTime(timeStampInSeconds()), " _gat=1;"),
    'accept-encoding': 'gzip, deflate, br',
    'accept-language': 'es-ES,es;q=0.9',
    'connection': 'keep-alive',
    'host': 'yopmail.com',
  ...
  WEBMAIL_JS_URL: ver => "https://yopmail.com/ver/".concat(ver, "/webmail.js"),
